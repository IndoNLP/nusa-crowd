...
class JvId(datasets.GeneratorBasedBuilder):
    """jv_id contains high-quality Multi-speaker TTS data for Javanese (jv-ID)."""

    BUILDER_CONFIGS = [
        NusantaraConfig(
            name="jv_id_source",
            version=datasets.Version(_SOURCE_VERSION),
            description="JV_ID source schema",
            schema="source",
            subset_id="jv_id",
        ),
        NusantaraConfig(
            name="jv_id_nusantara_sptext",
            version=datasets.Version(_NUSANTARA_VERSION),
            description="JV_ID Nusantara schema",
            schema="nusantara_sptext",
            subset_id="jv_id",
        ),
    ]

    DEFAULT_CONFIG_NAME = "jv_id_source"
