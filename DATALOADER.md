...
Make a new directory within the `nusa-crowd/datasets` directory:
...
To start, copy [templates/template.py](templates/template.py) to your `nusa-crowd/datasets/<dataset_name>` directory with the name `<dataset_name>.py`. Within this file, fill out all the TODOs.
